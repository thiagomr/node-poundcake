...
function createApp(options) {
    try {
        ...
        const baseDir = 'src/templates/js';
        const baseFiles = loadFiles(`${baseDir}/base`);
        const packageFile = require('./templates/js/base/package.json');
        ...
        fs.writeFileSync(`${options.name}/package.json`, JSON.stringify(packageFile, undefined, 2));
